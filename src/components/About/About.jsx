        ...
        <div className={styles.sections} style={{ marginBottom: "2px" }}>
          <div className={styles.text}>
            ...
            <p className={styles.paragraph}>
              Voam is a Clothing brand with roots located in Bulgaria. Within
              our first year we have managed to sell out multiple drops. We saw
              ...
              to deliver pleasurable experience to every single client along
              with a high-quality product representing the wave we are currently
              on.
            </p>
          </div>
        ...
        <div className={styles.sections}>
          ...
          <div className={styles.text}>
            ...
            <p className={styles.paragraph}>
              ...
              contribute to the community that they are already part of- The
              Voam community. Every drop is symbolic and represents a new
              message we want to get through the people. We want everyone to
              find a piece he/she can see himself/herself in.
            </p>
          </div>
        </div>
      </div>
